...
const VIDEOS = [
  ...
  {
    id: 9,
    titleKey: 'training.vid9Title',
    descKey: 'training.vid9Desc',
    category: 'chatbots',
    duration: '6 min',
    icon: '\u{1F6E0}\uFE0F',
  ...
  {
    id: 10,
    titleKey: 'training.vid10Title',
    descKey: 'training.vid10Desc',
    category: 'chatbots',
    duration: '5 min',
    icon: '\u{1F916}',
    youtubeId: 'PLACEHOLDER_10',
  },
  // Phone Numbers
  {
    id: 11,
    titleKey: 'training.vid11Title',
    descKey: 'training.vid11Desc',
    category: 'phone',
    duration: '4 min',
    icon: '\u{1F4F1}',
    youtubeId: 'PLACEHOLDER_11',
  },
  // Integrations
  {
    id: 12,
    titleKey: 'training.vid12Title',
    descKey: 'training.vid12Desc',
    category: 'integrations',
    duration: '6 min',
    icon: '\u{1F4C5}',
    youtubeId: 'PLACEHOLDER_12',
  },
  {
    id: 13,
    titleKey: 'training.vid13Title',
    descKey: 'training.vid13Desc',
    category: 'integrations',
    duration: '10 min',
    icon: '\u{1F517}',
    youtubeId: 'PLACEHOLDER_13',
  },
  // Analytics & Calls
  {
    id: 14,
    titleKey: 'training.vid14Title',
    descKey: 'training.vid14Desc',
    category: 'analytics',
    duration: '6 min',
    icon: '\u{1F4CA}',
    youtubeId: 'PLACEHOLDER_14',
  },
  {
    id: 15,
    titleKey: 'training.vid15Title',
    descKey: 'training.vid15Desc',
    category: 'analytics',
    duration: '5 min',
    icon: '\u{1F4CB}',
    youtubeId: 'PLACEHOLDER_15',
  },
  {
    id: 16,
    titleKey: 'training.vid16Title',
    descKey: 'training.vid16Desc',
    category: 'analytics',
    duration: '4 min',
    icon: '\u{1F504}',
    youtubeId: 'PLACEHOLDER_16',
  },
  // Management
  {
    id: 17,
    titleKey: 'training.vid17Title',
    descKey: 'training.vid17Desc',
    category: 'management',
    duration: '5 min',
    icon: '\u{1F465}',
    youtubeId: 'PLACEHOLDER_17',
  },
  {
    id: 18,
    titleKey: 'training.vid18Title',
    descKey: 'training.vid18Desc',
    category: 'management',
    duration: '6 min',
    icon: '\u{1F3E2}',
    youtubeId: 'PLACEHOLDER_18',
  },
  {
    id: 19,
    titleKey: 'training.vid19Title',
    descKey: 'training.vid19Desc',
    category: 'management',
    duration: '4 min',
    icon: '\u{1F310}',
    youtubeId: 'PLACEHOLDER_19',
  },
  // Billing
  {
    id: 20,
    titleKey: 'training.vid20Title',
    descKey: 'training.vid20Desc',
    category: 'billing',
    duration: '3 min',
    icon: '\u{1F4B3}',
    youtubeId: 'PLACEHOLDER_20',
  },
  // Settings
  {
    id: 21,
    titleKey: 'training.vid21Title',
    descKey: 'training.vid21Desc',
    category: 'settings',
    duration: '5 min',
    icon: '\u{2699}\uFE0F',
    youtubeId: 'PLACEHOLDER_21',
  },
  {
    id: 22,
    titleKey: 'training.vid22Title',
    descKey: 'training.vid22Desc',
    category: 'settings',
    duration: '4 min',
    icon: '\u{1F3A8}',
    youtubeId: 'PLACEHOLDER_22',
  },
  {
    id: 23,
    titleKey: 'training.vid23Title',
    descKey: 'training.vid23Desc',
    category: 'settings',
    duration: '5 min',
    icon: '\u{1F512}',
    youtubeId: 'PLACEHOLDER_23',
  },
]
...
const CATEGORY_KEYS = [
  ...
  { id: 'chatbots', labelKey: 'training.catChatbots' },
  { id: 'phone', labelKey: 'training.catPhone' },
  { id: 'integrations', labelKey: 'training.catIntegrations' },
  { id: 'analytics', labelKey: 'training.catAnalytics' },
  { id: 'management', labelKey: 'training.catManagement' },
  { id: 'billing', labelKey: 'training.catBilling' },
  { id: 'settings', labelKey: 'training.catSettings' },
]
