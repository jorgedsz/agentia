        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border p-8 sm:p-12 shadow-sm">
          ...
          {language === 'en' ? (
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <p>Welcome to Sword AI Solutions. By accessing or using our platform (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.</p>
              ...
              <p>Sword AI Solutions provides an AI-powered voice agent platform that enables users to:</p>
              <ul>
              ...
              <ul>
                <li>The Service, including its design, code, and branding, is owned by Sword AI Solutions</li>
              ...
              <ul>
                ...
                <li>Execute a Business Associate Agreement (BAA) with Sword AI Solutions</li>
              ...
              <p>You agree to indemnify and hold harmless Sword AI Solutions, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of the Service, violation of these Terms, or infringement of any third-party rights.</p>
              ...
              <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction where Sword AI Solutions is incorporated, without regard to conflict of law provisions.</p>

              <h2>17. Contact Us</h2>
              <p>For questions about these Terms, please contact us at:</p>
              <p><strong>Sword AI Solutions</strong><br />Email: legal@swordaisolutions.com</p>
            </div>
          ) : (
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <p>Bienvenido a Sword AI Solutions. Al acceder o usar nuestra plataforma (el "Servicio"), usted acepta estar sujeto a estos Terminos de Servicio ("Terminos"). Si no esta de acuerdo con estos Terminos, no use el Servicio.</p>
              ...
              <p>Sword AI Solutions proporciona una plataforma de agentes de voz impulsados por IA que permite a los usuarios:</p>
              <ul>
              ...
              <ul>
                <li>El Servicio, incluyendo su diseno, codigo y marca, es propiedad de Sword AI Solutions</li>
              ...
              <ul>
                ...
                <li>Ejecutar un Acuerdo de Asociado Comercial (BAA) con Sword AI Solutions</li>
              ...
              <p>Usted acepta indemnizar y mantener indemne a Sword AI Solutions, sus directivos, directores, empleados y agentes de cualquier reclamacion, dano, perdida o gasto que surja de su uso del Servicio, violacion de estos Terminos o infraccion de derechos de terceros.</p>
              ...
              <p>Estos Terminos se regiran e interpretaran de acuerdo con las leyes de la jurisdiccion donde Sword AI Solutions esta incorporada, sin tener en cuenta las disposiciones sobre conflictos de leyes.</p>
